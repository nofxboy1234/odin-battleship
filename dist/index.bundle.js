  ...
  async play(targetGameboardElement) {
    ...
    if (this.target.ship) {
      ...
      if (hits.length === 1) {
        ...
        const potentialHits = [];
        if (!this.#isHitAgainstTopWall(onlyHit) && !allShots.includes(top) && !allAdjacentCells.includes(top)) {
          potentialHits.push(top);
        }
        if (!this.#isHitAgainstRightWall(onlyHit, targetGameboard) && !allShots.includes(right) && !allAdjacentCells.includes(right)) {
          potentialHits.push(right);
        }
        if (!this.#isHitAgainstBottomWall(onlyHit, targetGameboard) && !allShots.includes(bottom) && !allAdjacentCells.includes(bottom)) {
          potentialHits.push(bottom);
        }
        if (!this.#isHitAgainstLeftWall(onlyHit) && !allShots.includes(left) && !allAdjacentCells.includes(left)) {
        ...
        if (ship.orientation === 'horizontal') {
          ...
          const potentialHits = [];
          if (!this.#isHitAgainstLeftWall(firstHit) && !allShots.includes(left) && !allAdjacentCells.includes(left)) {
            potentialHits.push(left);
          }
          if (!this.#isHitAgainstRightWall(lastHit, targetGameboard) && !allShots.includes(right) && !allAdjacentCells.includes(right)) {
            potentialHits.push(right);
          }
          const randomIndex = getRandomInt(potentialHits.length);
          nextShot = potentialHits[randomIndex];
        ...
        if (ship.orientation === 'vertical') {
          ...
          const potentialHits = [];
          if (!this.#isHitAgainstTopWall(firstHit) && !allShots.includes(top) && !allAdjacentCells.includes(top)) {
            potentialHits.push(top);
          }
          if (!this.#isHitAgainstBottomWall(lastHit, targetGameboard) && !allShots.includes(bottom) && !allAdjacentCells.includes(bottom)) {
            potentialHits.push(bottom);
          }
          const randomIndex = getRandomInt(potentialHits.length);
          nextShot = potentialHits[randomIndex];
      ...
      const availableCells = this.#getAvailableCells(targetGameboard, allShots, allAdjacentCells);
